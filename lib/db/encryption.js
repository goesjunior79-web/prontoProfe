...
function getMasterSecret() {
  // Aceita ambos por compat. ENCRYPTION_MASTER_KEY é o nome canônico (Fase 2.1).
  return process.env.ENCRYPTION_MASTER_KEY || process.env.SUPABASE_ENCRYPTION_SECRET;
}
