...
const COLUMNS = 'id, user_id, nome, turma, serie, obs_nee, consent_at, created_at, updated_at';
 ...
 */
export async function createAluno({ userId, nome, turma, serie = null, obs_nee = null, consentido = false }) {
...
export async function updateAluno(userId, alunoId, updates) {
  ...
  const allowed = ['nome', 'turma', 'serie', 'obs_nee'];
