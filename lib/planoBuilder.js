...
// 8 seções do PTD v3 — versão institucional definitiva (2026-05-01).
// Mantida em sincronia com docs/prompts-esposa/app-prompts/01-ptd.md v3
// e docs/specs/PROMPT-MESTRE.md.
//
// Cada seção pode ter formas alternativas (sem acento, plural) pra que o
// parser reconheça outputs com variações pequenas do LLM.
const SECOES = [
